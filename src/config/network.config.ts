...
export const network =
  (process.env.VUE_APP_PUBLIC_NETWORK as Network) || Network.SIGNET;
...
const mainnetConfig: NetworkConfig = {
  ...
  coinSymbol: "BTC",
  networkName: "BTC",
  mempoolApiUrl: `${process.env.VUE_APP_PUBLIC_MEMPOOL_API}`,
...
const signetConfig: NetworkConfig = {
  ...
  mempoolApiUrl: `${process.env.VUE_APP_PUBLIC_MEMPOOL_API}/signet`,
...
const testnetConfig: NetworkConfig = {
  ...
  mempoolApiUrl: `${process.env.VUE_APP_PUBLIC_MEMPOOL_API}/testnet`,
