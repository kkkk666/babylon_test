<template>
  ...
  <div v-if="finalityProviders.length > 0" class="hidden gap-2 px-4 lg:grid lg:grid-cols-stakingFinalityProvidersDesktop">
...
<script>
  ...
  import LoadingTableList from '@/components/Loading/LoadingTableList.vue'; // Adjust path as necessary
